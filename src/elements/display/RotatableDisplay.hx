...
class RotatableDisplay extends Display
{
    ...
    // FIX: Pre-allocate the point object to prevent per-frame allocations
    ...
    public function new(x:Int, y:Int, width:Int, height:Int, color = 0x00000000) {
        ...
        // FIX: Assign a pre-allocated object
        sinVec.x = 1.0;
        sinVec.y = 0.0;
    ...
    private function set_rotation(deg:Float):Float {
        ...
        // FIX: Modify the pre-allocated object, then re-assign to trigger Peote View's setter
