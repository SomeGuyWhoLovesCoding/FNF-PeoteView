...
extern class File {
	...
	@:native("insertNote") static function insertNote(atIndex:Int64, value:MetaNote):Void;
	...
	@:native("getTempNote") static function getTempNote(atIndex:Int64):Void; // For the temp shit
}
#elseif hl
class File {
	...
	@:hlNative("chart_file", "insertNote") public static function insertNote(value:MetaNote):Void {}
	...
	@:hlNative("chart_file", "getTempNote") static function getTempNote(atIndex:Int64):Void; // For the temp shit
}
#end
