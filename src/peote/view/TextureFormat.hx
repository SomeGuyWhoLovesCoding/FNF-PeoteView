...
abstract TextureFormat(Int) from Int to Int  
{
    ...
    **/
    ...
    inline function get_isFloat():Bool return (this > LUMINANCE_ALPHA && this < ASTC_44);
    ...
    **/
    ...
    inline function isGreaterFloatR():Bool return this > FLOAT_R && this < ASTC_44;
    inline function isGreaterFloatRG():Bool return this > FLOAT_RG && this < ASTC_44;
    inline function isGreaterFloatRGB():Bool return this > FLOAT_RGB && this < ASTC_44;
    ...
    **/
    ...
    inline function get_bytesPerPixel():Int {
        if ( isCompressed ) return 1; // 16 bytes per 4x4 block = 1 byte per pixel average
    ...
    **/
    ...
    inline function get_channels():Int {
        if ( isCompressed ) return 4; // ASTC_44 contains RGBA
