...
HL_PRIM void HL_NAME(setBackgroundTrackVolume)(int index, double volume)    { g_mixer.setBackgroundTrackVolume(index, volume); }
...
HL_PRIM double HL_NAME(setMixerMasterVolume)(double volume)  { return g_mixer.setMasterVolume(volume); }
...
DEFINE_PRIM(_VOID, setBackgroundTrackVolume,  _I32 _F64)
...
DEFINE_PRIM(_F64,  getMixerMasterVolume,      _NO_ARG)
