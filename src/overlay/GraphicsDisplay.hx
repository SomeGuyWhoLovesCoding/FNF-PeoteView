...
/**
        ...
        options behave exactly like the other options lists.
        @since Development
**/
@:publicFields
class GraphicsDisplay extends OptionsSubDisplay {
        public static var graphicsStr(default, null):Array<String> = ["resolution", "fullscreen", "vsync", "frameRate", "compressTextures", "antialiasing"];
        ...
        function enter() {
                ...
                switch (graphicsStr[index]) {
                        ...
                        case "compressTextures":
                                ...
                                SaveData.save();
                        case "antialiasing":
                                SaveData.state.preferences.antialiasing = !SaveData.state.preferences.antialiasing;
                                SaveData.save();
                        case "frameRate":
                                changeFrameRate(1);
                }
        ...
        function getValueString(index:Int):String {
                ...
                switch (graphicsStr[index]) {
                        ...
                        case "antialiasing":
                                return SaveData.state.preferences.antialiasing ? "ON" : "OFF";
                        case "vsync":
                                #if LIME_840
