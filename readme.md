...
Funkin' View (AKA FNF' in Peote-View) is a successor of [Friday Night Funkin' Zenith](https://github.com/SomeGuyWhoLovesCoding/Zenith-FNF-Public) and is the fastest performing framework that uses fnf elements, ever.
...
To compile without lua *for alory - add -D FV_NO_LUA to your compile command